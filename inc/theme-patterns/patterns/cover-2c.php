...
return array(
    'title'      => __('First Read Two Column', 'iv-active'),
...
<div class="wp-block-column col-lg-7"><!-- wp:heading {"textAlign":"left","level":1,"textColor":"white"} -->
<h1 class="wp-block-heading has-text-align-left has-white-color has-text-color">Feel Better Faster</h1>
<!-- /wp:heading -->

<!-- wp:heading {"textAlign":"left","textColor":"aqua"} -->
<h2 class="wp-block-heading has-text-align-left has-aqua-color has-text-color"><strong>#1 Mobile IV Therapy in PA</strong></h2>
<!-- /wp:heading -->
...
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link has-white-background-color has-background wp-element-button">Call Us</a></div>
<!-- /wp:button -->

<!-- wp:button {"className":"is-style-outline"} -->
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button">Text Us</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
