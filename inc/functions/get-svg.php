...
?>
	...
	<svg <?php
		...
		$icon_path = esc_html($args['icon']);
		$svg_url = get_parent_theme_file_uri(ICON_PATH . '?ver=' . $svg_version . '#' . $icon_path);

		if (is_customize_preview()) :
		?>
			<use xlink:href="<?php echo esc_url($svg_url); ?>"></use>
		<?php else : ?>
			<use xlink:href="<?php echo esc_url($svg_url); ?>"></use>
		<?php endif; ?>
