...
function happytapir_remove_default_customizer_sections($wp_customize)
{
...
add_action('customize_register', 'happytapir_remove_default_customizer_sections', 15);
 ...
 */
function happytapir_include_custom_controls()
{
...
add_action('customize_register', 'happytapir_include_custom_controls', -999);
 ...
 */
function happytapir_customize_scripts()
{
	wp_enqueue_script('happytapir-customize-livepreview', get_stylesheet_directory_uri() . '/inc/customizer/assets/scripts/livepreview.js', array('jquery', 'customize-preview'), '1.0.0', true);
}
add_action('customize_preview_init', 'happytapir_customize_scripts');
 ...
 */
function happytapir_selective_refresh_support($wp_customize)
{
	...
	$settings = array(
		...
		'happytapir_copyright_text' => '.site-info',
	);
...
add_action('customize_register', 'happytapir_selective_refresh_support');
 ...
 */
function happytapir_live_preview_support($wp_customize)
{
...
add_action('customize_register', 'happytapir_live_preview_support', 999);
