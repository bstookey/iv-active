...
function iv_active_remove_default_customizer_sections($wp_customize)
{
...
add_action('customize_register', 'iv_active_remove_default_customizer_sections', 15);
 ...
 */
function iv_active_include_custom_controls()
{
...
add_action('customize_register', 'iv_active_include_custom_controls', -999);
 ...
 */
function iv_active_customize_scripts()
{
	wp_enqueue_script('iv_active-customize-livepreview', get_stylesheet_directory_uri() . '/inc/customizer/assets/scripts/livepreview.js', array('jquery', 'customize-preview'), '1.0.0', true);
}
add_action('customize_preview_init', 'iv_active_customize_scripts');
 ...
 */
function iv_active_selective_refresh_support($wp_customize)
{
	...
	$settings = array(
		...
		'iv_active_copyright_text' => '.site-info',
	);
...
add_action('customize_register', 'iv_active_selective_refresh_support');
 ...
 */
function iv_active_live_preview_support($wp_customize)
{
...
add_action('customize_register', 'iv_active_live_preview_support', 999);
