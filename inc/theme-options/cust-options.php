...
class Cust_Theme_Options
{
    ...
    public function display_about_section()
    {
        ...
        //echo '<p>Copyright 2023 info@astriata.com</p>';
...
<?php break;
    ...
    public function get_settings()
    {
        ...
        $this->settings['newsletter_heading'] = array(
            'section' => 'general',
            'title' => '', // Not used for headings.
            'desc' => 'Newsletter',
            'type' => 'heading'
        ...
        $this->settings['newsletter-signup'] = array(
            'title' => __('Newsletter URL'),
            'type' => 'text',
            'desc' => __(''),
            'section' => 'general'
        );

        $this->settings['newsletter-signup-id'] = array(
            'title' => __('General Newsletter ID'),
            'type' => 'text',
            'desc' => __(''),
            'section' => 'general'
        );
