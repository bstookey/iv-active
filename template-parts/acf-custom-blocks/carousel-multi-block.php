        ...
        <?php elseif (get_row_layout() == 'testimonials') : ?>
            <?php if (have_rows('testimonials')): ?>
                <div class="testimonial-carousel <?php echo esc_attr($classes); ?>">
                                    ...
                                    <div class="carousel-item">
                                        <div class="iv-carousel-item">
                                            ...
                                            <div class="testimonial-content">
                                                <div class="testimonial-text"><?= esc_html(get_post_field('post_content', $testimonial_id)) ?></div>
                                                <div class="testimonial-title"><strong> - <?= esc_html(get_the_title($testimonial_id)) ?></strong></div>
                                            </div>
                                        </div>
                                    </div>
                                <?php
                                    $i++; // Increment $i correctly here
                                else: ?>
                    ...
                    <div class="testimonial-navigation"> <a class="carousel-control-prev" href="#carousel-<?= $blockid ?>" role="button" data-bs-slide="prev">
